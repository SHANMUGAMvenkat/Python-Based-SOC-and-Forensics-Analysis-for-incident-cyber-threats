...
def urlscanio():
    ...
    response = requests.post('https://urlscan.io/api/v1/scan/', headers=headers, json={"url": url_to_scan, "visibility": scan_type}).json()
...
def extrasMenu():
    ...
    print(" --------------------------------- ")
    print(" What would you like to do? ")
    print(" OPTION 1: About SOC ")
    print(" OPTION 2: Contributors ")
    extrasSwitch(input())

def aboutSooty():
    print(' SOC is tool that help analyze the Top layer of security')
    extrasMenu()

def contributors():
    print(' CONTRIBUTORS')
    print(" SHANMUGAM V 20111051 - B.E CYBER SECURITY")
    print(" KAPILSURYA R 20111023 - B.E CYBER SECURITY")
    print(" SARAN KUMAR R 20111302 - B.E CYBER SECURITY")
    extrasMenu()
